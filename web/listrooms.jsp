...
<%@ page session="true" errorPage="error.jsp" import="java.util.Set,java.util.Iterator,java.util.Map,com.in.chat.*"%>
 <HTML>
<HEAD>
...
<BR>
	...
	%>
<DIV align="center" style="width: 100%;height: 350px; overflow: hidden;">
<CENTER>
